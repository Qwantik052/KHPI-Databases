...
CREATE TABLE sgroup (group_id SERIAL PRIMARY KEY, name VARCHAR(30) NOT NULL);

CREATE TABLE student (student_id SERIAL PRIMARY KEY, group_id INT, first_name VARCHAR(100) NOT NULL,
last_name VARCHAR(100) NOT NULL, code INT);
